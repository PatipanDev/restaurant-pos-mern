...
interface WarningAlertProps {
  messagealert?: React.ReactNode | null;  // เปลี่ยนเป็น React.ReactNode | null
  duration?: number; // ระยะเวลาในการแสดง Alert
}

const WarningAlertText: React.FC<WarningAlertProps> = ({ messagealert, duration = 3000 }) => {
  ...
  return (
    ...
    >
      {messagealert} {/* แสดงข้อความที่รับมา */}
    </Alert>
  );
};

export default WarningAlertText;
